...
<head>
    ...
    <script type="text/javascript" src="${_jsPath }/pages/coupon/editWechatCoupon.js"></script>
...
<div class="body m-w980p">
    ...
    <ul class="m-clear">
      ...
      <li><a class="current-chose" href="${_ctxPath}/admin/coupon/coupon-editWechatCoupon.htm">微信优惠券</a></li>
      </aut:authorize>
...
<div class="m-mt10p">
<form id="addForm">
	<input type="hidden" name="event.type" value="<%=Event.TYPE_WECHAT%>"/>
	...
	<table id="addTable" class="tab-wechat" width="100%">
		...
		<tbody>
            <tr>
                ...
                <td class="hb-td">
                    <input class="j-edited Wdate" type="text" name="event.couponConfigList[0].startTime" 
                    	id="startTime" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'endTime\')}',minDate:'%y-%M-%d',readOnly:true})" />
                    至
                    <input class="j-edited Wdate" type="text" name="event.couponConfigList[0].endTime" 
                    ...
                    <table width="100%" height="100%" id="dataTable">
                        <tbody>
                            <tr class="list-tr">
                                ...
                                <td width="69"><a href="javascript:void(0);" class="new_tr">新增</a></td>
                            </tr>
                        </tbody>
                    </table>
                </td>
